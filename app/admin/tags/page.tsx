    ...
    <div>
      <div style={{ marginBottom: 24 }}>
        ...
        <p style={{ fontSize: 13, color: "hsl(var(--muted-foreground))", marginTop: 4 }}>
          Přidělte hráčům tagy. Super tagy se zobrazují přímo vedle jména v žebříčku.
        </p>
      </div>
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: 4 }}>
            {filtered.map(name => {
              ...
              return (
                <button
                  key={name}
                  onClick={() => router.push(`/admin/tags/${encodeURIComponent(name)}`)}
                  style={{
                ...
                >
                  {hasTag
                    ...
                    : <Tag size={14} color="hsl(var(--muted-foreground))" style={{ flexShrink: 0 }} />
                  }
