...
function heroMiniStatsHtml(obj){
  if (!obj){
    return `
      ...
      <div class="heroMiniStat"><b>win</b><span>—</span></div>
      <div class="heroMiniStat"><b>loss</b><span>—</span></div>
      <div class="heroMiniStat"><b>draw</b><span>—</span></div>
  ...
  return `
    ...
    <div class="heroMiniStat"><b>win</b><span>${safeInt(obj.win)}</span></div>
    <div class="heroMiniStat"><b>loss</b><span>${safeInt(obj.loss)}</span></div>
    <div class="heroMiniStat"><b>draw</b><span>${safeInt(obj.draw)}</span></div>
