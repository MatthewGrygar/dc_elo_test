...
export function AppProvider({ children }: { children: React.ReactNode }) {
  ...
  return (
    <AppContext.Provider value={{ ...state, navigateTo, openPlayer, closePlayer, setPlayerSubView, setLang, setSidebarOpen }}>
      {children}
    </AppContext.Provider>
  );
}
