...
const DICT = {
  ...
  en: {
    ...
    project_desc:
      "This project brings ELO ratings to the Duel Commander community. Our goal is to rate player performance fairly, support competition, and provide a clear long-term ranking.",
  ...
  fr: {
    ...
    project_desc:
      "Ce projet apporte un classement ELO à la communauté Duel Commander. Notre objectif est d’évaluer les performances de manière équitable, de soutenir la compétition et d’offrir un classement clair sur le long terme.",
